...
cl = LINETCR.LINE()
cl.login(token="EllTiZCUwbJcNpUgjKyb.s6bD8YHeZ6XmNXI1Sjn6kW.OjXACZ+gQid0KZE0Ticow2dd2Gc6elm0KFVIQsSlBwA=")
cl.loginResult()
...
admin=["uefa7edf086833f1ab48a48e3c6a01357"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ki.sendText(msg.to,"Selamat datang di Chivas&TCR Family Room")
